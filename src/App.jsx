...
import ClaimDNO from "components/ClaimDNO";
      ...
      <Router>
        ...
        <div style={styles.content}>
          <Switch>
            ...
            <Route path="/claim-dno">
              <ClaimDNO />
            </Route>

            <Route path="/nft-contract">
              <ContractDelicateDinos />
            </Route>

            <Route path="/dno-contract">
              <ContractDelicateDinosToken />
            </Route>
